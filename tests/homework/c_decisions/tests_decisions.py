...
def test_get_faculty_rating(self): 
      ...
      self.assertEqual(get_options_ratio (.91)),"Excellent" 
      self.assertEqual(get_options_ratio(.85)),"Very Good"
      self.assertEqual(get_options_ratio(.71)),"Good"
      self.assertEqual(get_options_ratio(.66)),"Needs Improvement"
      self.assertEqual(get_options_ratio(.45)),"Unacceptable"
